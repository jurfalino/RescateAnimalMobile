...
<div class="fieldcontain ${hasErrors(bean: bookInstance, field: 'author', 'error')} required">
	...
	<g:select id="author" name="author.id" from="${org.rescate.Author.list()}" optionKey="id" required="" value="${bookInstance?.author?.id}" class="many-to-one"/>
